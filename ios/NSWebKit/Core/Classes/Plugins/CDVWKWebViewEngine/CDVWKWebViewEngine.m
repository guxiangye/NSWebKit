...
- (void)pluginInitialize
{
    ...
    uiDelegate.viewController = (CDVViewController *)self.viewController;
...
{
    [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:CDVPageShouldStartLoadNotification object:webView]];
}
...
{
    [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:CDVPageDidLoadFailNotification object:@{@"error":error,@"webview":self.webView}]];
}
