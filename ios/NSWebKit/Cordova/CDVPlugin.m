...
NSString* const CDVPageShouldStartLoadNotification = @"CDVPageShouldStartLoadNotification";
...
- (instancetype)initWithWebViewEngine:(id <CDVWebViewEngineProtocol>)theWebViewEngine
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onReset) name:CDVPageShouldStartLoadNotification object:theWebViewEngine.engineWebView];
