...
{
    SecCertificateRef myCertificate = SecCertificateCreateWithData(kCFAllocatorDefault, (__bridge CFDataRef)certData);
...
-(SecKeyRef) getPrivateKeyRefrenceFromData: (NSData*)p12Data password:(NSString*)pkcsPassword
{
...
+ (NSData *)encryptData:(NSData *)data privateKey:(NSString *)privKey{
    ...
    return [RSAEncryptor encryptData:data withKeyRef:keyRef isSign:YES];
}
...
+ (NSData *)encryptData:(NSData *)data publicKey:(NSString *)pubKey{
    ...
    return [RSAEncryptor encryptData:data withKeyRef:keyRef isSign:NO];
}
