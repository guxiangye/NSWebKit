...
/** Category of additions for `<NSFMDatabase>` class.
...
@interface NSFMDatabase (NSFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `NSFMResultSet` of schema; `nil` on error.
