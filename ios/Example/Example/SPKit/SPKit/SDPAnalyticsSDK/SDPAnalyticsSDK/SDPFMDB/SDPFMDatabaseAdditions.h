...
/** Category of additions for `<SDPFMDatabase>` class.
...
@interface SDPFMDatabase (SDPFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `SDPFMResultSet` of schema; `nil` on error.
