...
const core = {
    ...
    cordovaExecSync(pluginName, apiName, arr = []) {
        ...
        if (isiOS) {
            let command = "SPCordovaExecSync=" + JSON.stringify([pluginName, apiName, arr]);
            ...
            let result = _plugins_ns_core__WEBPACK_IMPORTED_MODULE_0__.jsSyncFunction.syncExec(pluginName, apiName, arr);
            if (typeof result == "string") {
                return JSON.parse(result);
            }
            return result;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   jsSyncFunction: () => (/* binding */ jsSyncFunction)
/* harmony export */ });
var jsSyncFunction;
