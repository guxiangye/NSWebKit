...
/**
 * This class is the WebChromeClient that implements callbacks for our web view. The kind of
 * callbacks that happen here are on the chrome outside the document, such as onCreateWindow(),
 * onConsoleMessage(), onProgressChanged(), etc. Related to but different than
