package com.nswebkit.plugins.scan.scan.model;

import com.nswebkit.plugins.scan.R;
import com.nswebkit.plugins.scan.scan.CaptureActivity;
...
public class MNScanConfig implements Serializable {
    ...
    //支持二维码还是条形码，0：都支持  1.只支持二维码  2.只支持条形码。
    private int supportCode = 0;
    ...
    private MNScanConfig(Builder builder) {
        ...
        supportCode = builder.supportCode;
    }
    ...
    public static class Builder {
        ...
        public Builder setSupportCode(int code) {
