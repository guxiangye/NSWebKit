...
import com.nswebkit.plugins.scan.scan.manager.BeepManager;
import com.nswebkit.plugins.scan.scan.manager.InactivityTimer;
...
//        });
        ...
        resultPointView.setOnResultPointClickListener(new ScanResultPointView.OnResultPointClickListener() {
            @Override
            public void onPointClick(Result[] rawResult) {
                if (onScanCallback != null) {
                    onScanCallback.onScanSuccess(rawResult, null);
                }
            }
    ...
    public void init() {
        ...
        scanSurfaceViewHandler = new ScanSurfaceViewHandler(this, decodeFormats, null, characterSet, cameraManager,scanConfig);
    }
    ...
    public void handleDecode(Result[] rawResult, Bitmap barcode, float scaleFactor) {
        ...
        if (rawResult.length == 1) {
            if (onScanCallback != null) {
                onScanCallback.onScanSuccess(rawResult, barcode);
            }
        }
