...
/**
 * author: date on: 5/25/23 description:
 * @author neil
 */
public class NSWhitelistPlugin extends CordovaPlugin {
     ...
     * */
    public NSWhitelistPlugin() {
    }
    /**
     * These can be used by embedders to allow Java-configuration of whitelists.
     * */
    public NSWhitelistPlugin(Context context) {
        this(new Whitelist(), new Whitelist(), null);
        new CustomConfigXmlParser().parse(context);
    }
    public NSWhitelistPlugin(XmlPullParser xmlParser) {
        this(new Whitelist(), new Whitelist(), null);
        new CustomConfigXmlParser().parse(xmlParser);
    }
    public NSWhitelistPlugin(Whitelist allowedNavigations, Whitelist allowedIntents, Whitelist allowedRequests) {
